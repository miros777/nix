'use strict';
    ...
    app: { //Пути откуда брать исходники
        ...
        php: 'app/*.php', //Синтаксис src/*.html говорит gulp что мы хотим взять все файлы с расширением .html
...
gulp.task('js:build', function () {
    gulp.src(path.app.js) //Найдем наш main файл
        .pipe(uglify().on('error', function(e){
            console.log(e); // Если есть ошибки в js то покажет
         }))
...
// для вывода ошибки без перезагрузки gulpstart
